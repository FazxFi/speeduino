...
void initialiseAirCon()
{
  if( configPage15.airConEnable == 1 && configPage15.airConReqPin !=0 )
  {
    ...
    if(pinAirConFan != 0)  { acStandAloneFanIsEnabled = true; }
...
void airConControl()
{
  if(acIsEnabled == true)
  {
    ...
    if ( (rpmBy16 < configPage15.airConMinRPMdiv16) || (currentStatus.RPMdiv100 > configPage15.airConMaxRPMdiv100) )
    {
      // A/C is cut off due to high/low RPM
      BIT_SET(currentStatus.airConStatus, BIT_AIRCON_RPM_LOCKOUT);
      acRPMLockoutDelay = 0;
    }
    else if ( (currentStatus.RPMdiv100 >= configPage15.airConMinRPMdiv16) &&
